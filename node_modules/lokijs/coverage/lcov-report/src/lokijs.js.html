...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">65.32% <small>(840 / 1286)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">55.16% <small>(374 / 678)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">64.02% <small>(105 / 164)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">65.18% <small>(833 / 1278)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
3164
3165
3166</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >          return checkFn(curr);</span>
    ...
    var fs = (typeof exports === 'object') ? require('fs') : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >              applyListener(listener, args);</span>
            }, 1);
          } else {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.ENV === 'NODEJS') {
        this.fs = require("fs");
      }
...
&nbsp;
      this.persistenceMethod = null;
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.hasOwnProperty('persistenceMethod')) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.hasOwnProperty('adapter')) {
<span class="cstat-no" title="statement not covered" >        this.persistenceMethod = 'adapter';</span>
<span class="cstat-no" title="statement not covered" >        this.persistenceAdapter = options.adapter;</span>
      }
&nbsp;
      // if they want to load database on loki instantiation, now is a good time to load... after adapter set and before possible autosave initiation
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.hasOwnProperty('autoload') &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof (initialConfig) !== 'undefined' </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >initialConfig)</span> {
<span class="cstat-no" title="statement not covered" >        this.loadDatabase({}, options.autoloadCallback);</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this.autosaveInterval = parseInt(this.options.autosaveInterval);</span>
      }
&nbsp;
...
&nbsp;
    Loki.prototype.removeCollection = <span class="fstat-no" title="function not covered" >function (collectionName) {</span>
<span class="cstat-no" title="statement not covered" >      var i,</span>
        len = this.collections.length;
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (i = 0; i &lt; len; i += 1) {</span>
<span class="cstat-no" title="statement not covered" >        if (this.collections[i].name === collectionName) {</span>
<span class="cstat-no" title="statement not covered" >          this.collections.splice(i, 1);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      throw 'No such collection';</span>
    };
&nbsp;
...
&nbsp;
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (copyColl.data.length &gt; 0) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!copyColl.data[0].hasOwnProperty('$loki')) {
<span class="cstat-no" title="statement not covered" >              var dlen = copyColl.data.length;</span>
<span class="cstat-no" title="statement not covered" >              var currDoc = null;</span>
&nbsp;
              // for each document, set $loki to old 'id' column
              // if it has 'originalId' column, move to 'id'
<span class="cstat-no" title="statement not covered" >              for (var idx = 0; idx &lt; dlen; idx++) {</span>
<span class="cstat-no" title="statement not covered" >                currDoc = copyColl.data[idx];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                currDoc['$loki'] = currDoc['id'];</span>
<span class="cstat-no" title="statement not covered" >                delete currDoc.id;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (currDoc.hasOwnProperty['originalId']) {</span>
<span class="cstat-no" title="statement not covered" >                  currDoc['id'] = currDoc['originalId'];</span>
                }
              }
            }
          }
...
<span class="cstat-no" title="statement not covered" >          if (upgradeNeeded &amp;&amp; typeof (colldv.sortColumn) !== 'undefined' &amp;&amp; colldv.sortColumn != null) {</span>
<span class="cstat-no" title="statement not covered" >            var isdesc = false;</span>
<span class="cstat-no" title="statement not covered" >            if (typeof (colldv.sortColumnDesc) !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >              isdesc = colldv.sortColumnDesc;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            dv.sortCriteria = [colldv.sortColumn, isdesc];</span>
          } else {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.persistenceMethod != null) {
<span class="cstat-no" title="statement not covered" >        if (this.persistenceMethod === 'fs') {</span>
<span class="cstat-no" title="statement not covered" >          this.fs.readFile(this.filename, {</span>
            encoding: 'utf8'
          }, <span class="fstat-no" title="function not covered" >function readFileCallback(err, data) {</span>
<span class="cstat-no" title="statement not covered" >            if (err) {</span>
<span class="cstat-no" title="statement not covered" >              return cFun(err, null);</span>
            }
<span class="cstat-no" title="statement not covered" >            self.loadJSON(data, options || {});</span>
<span class="cstat-no" title="statement not covered" >            cFun(null, data);</span>
          });
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.persistenceMethod === 'localStorage') {</span>
<span class="cstat-no" title="statement not covered" >          if (localStorageAvailable()) {</span>
<span class="cstat-no" title="statement not covered" >            var data = localStorage.getItem(this.filename);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            self.loadJSON(data, options || {});</span>
<span class="cstat-no" title="statement not covered" >            cFun(null, data);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            cFun(new Error('localStorage is not available'));</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.persistenceMethod === 'adapter') {</span>
          // test if user has given us an adapter reference (in loki constructor options)
<span class="cstat-no" title="statement not covered" >          if (this.persistenceAdapter !== null) {</span>
<span class="cstat-no" title="statement not covered" >            this.persistenceAdapter.loadDatabase(this.filename, <span class="fstat-no" title="function not covered" >function loadDatabaseCallback(dbString) {</span></span>
<span class="cstat-no" title="statement not covered" >              if (typeof (dbString) === 'undefined' || dbString === null) {</span>
<span class="cstat-no" title="statement not covered" >                console.warn('lokijs loadDatabase : Database not found');</span>
<span class="cstat-no" title="statement not covered" >                cFun('Database not found');</span>
              } else {
<span class="cstat-no" title="statement not covered" >                self.loadJSON(dbString);</span>
<span class="cstat-no" title="statement not covered" >                cFun(null);</span>
              }
            });
          } else {
...
<span class="cstat-no" title="statement not covered" >            return cFun(err, null);</span>
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!data.length) {
<span class="cstat-no" title="statement not covered" >            data = self.serialize();</span>
          }
          self.loadJSON(data, options || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
          cFun(null, data);
        });
      } else <span class="cstat-no" title="statement not covered" >if (this.ENV === 'BROWSER') {</span>
<span class="cstat-no" title="statement not covered" >        if (localStorageAvailable()) {</span>
<span class="cstat-no" title="statement not covered" >          var data = localStorage.getItem(this.filename);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          self.loadJSON(data, options || {});</span>
...
<span class="cstat-no" title="statement not covered" >        cFun(new Error('unknown environment'));</span>
      }
    };
&nbsp;
    /**
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.persistenceMethod != null) {
<span class="cstat-no" title="statement not covered" >        if (this.persistenceMethod === 'fs') {</span>
<span class="cstat-no" title="statement not covered" >          self.fs.writeFile(self.filename, self.serialize(), cFun);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.persistenceMethod === 'localStorage') {</span>
<span class="cstat-no" title="statement not covered" >          if (localStorageAvailable()) {</span>
<span class="cstat-no" title="statement not covered" >            localStorage.setItem(self.filename, self.serialize());</span>
<span class="cstat-no" title="statement not covered" >            cFun(null);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            cFun(new Error('localStorage is not available'));</span>
          }
...
<span class="cstat-no" title="statement not covered" >          if (this.persistenceAdapter !== null) {</span>
<span class="cstat-no" title="statement not covered" >            this.persistenceAdapter.saveDatabase(this.filename, self.serialize(), <span class="fstat-no" title="function not covered" >function saveDatabasecallback() {</span></span>
<span class="cstat-no" title="statement not covered" >              cFun(null);</span>
            });
          } else {
<span class="cstat-no" title="statement not covered" >            cFun(new Error('persistenceAdapter not configured'));</span>
...
&nbsp;
      ...
      } else <span class="cstat-no" title="statement not covered" >if (this.ENV === 'BROWSER' || this.ENV === 'CORDOVA') {</span>
<span class="cstat-no" title="statement not covered" >        if (localStorageAvailable()) {</span>
<span class="cstat-no" title="statement not covered" >          localStorage.setItem(self.filename, self.serialize());</span>
<span class="cstat-no" title="statement not covered" >          cFun(null);</span>
        } else {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof (isdesc) === 'undefined') {
...
&nbsp;
     ...
     */
    Resultset.prototype.findOr = <span class="fstat-no" title="function not covered" >function (expressionArray) {</span>
<span class="cstat-no" title="statement not covered" >      var fri = 0,</span>
        ei = 0,
        fr = null,
        docset = [],
        expResultset = null;
...
<span class="cstat-no" title="statement not covered" >      if (this.filterInitialized) {</span>
...
<span class="cstat-no" title="statement not covered" >          expResultset = this.collection.chain();</span>
<span class="cstat-no" title="statement not covered" >          expResultset.find(expressionArray[ei]);</span>
<span class="cstat-no" title="statement not covered" >          expResultset.data();</span>
&nbsp;
          // add any document 'hits'
<span class="cstat-no" title="statement not covered" >          fr = expResultset.filteredrows;</span>
<span class="cstat-no" title="statement not covered" >          for (fri = 0; fri &lt; fr.length; fri++) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.filteredrows.indexOf(fr[fri]) === -1) {</span>
<span class="cstat-no" title="statement not covered" >              this.filteredrows.push(fr[fri]);</span>
            }
          }
        }
      }
...
&nbsp;
     ...
     * @returns {Resultset} this resultset for further chain ops.
     */
    Resultset.prototype.findAnd = <span class="fstat-no" title="function not covered" >function (expressionArray) {</span>
      // we have already implementing method chaining in this (our Resultset class)
      // so lets just progressively apply user supplied and filters
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; expressionArray.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >        this.find(expressionArray[i]);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this;</span>
    };
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (p === '$and') {
<span class="cstat-no" title="statement not covered" >            if (this.searchIsChained) {</span>
<span class="cstat-no" title="statement not covered" >              this.findAnd(queryObject[p]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              return this;</span>
            } else {
              // our and operation internally chains filters
<span class="cstat-no" title="statement not covered" >              return this.collection.chain().findAnd(queryObject[p]).data();</span>
            }
          }
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (p === '$or') {
<span class="cstat-no" title="statement not covered" >            if (this.searchIsChained) {</span>
<span class="cstat-no" title="statement not covered" >              this.findOr(queryObject[p]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              return this;</span>
            } else {
<span class="cstat-no" title="statement not covered" >              return this.collection.chain().findOr(queryObject[p]).data();</span>
            }
          }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              var root, paths;</span>
<span class="cstat-no" title="statement not covered" >              while (i--) {</span>
<span class="cstat-no" title="statement not covered" >                root = t[i];</span>
<span class="cstat-no" title="statement not covered" >                paths = property.split('.');</span>
...
<span class="cstat-no" title="statement not covered" >                if (fun(root, value)) {</span>
...
<span class="cstat-no" title="statement not covered" >              var root, paths;</span>
<span class="cstat-no" title="statement not covered" >              while (i--) {</span>
<span class="cstat-no" title="statement not covered" >                root = t[this.filteredrows[i]];</span>
<span class="cstat-no" title="statement not covered" >                paths = property.split('.');</span>
<span class="cstat-no" title="statement not covered" >                paths.forEach(<span class="fstat-no" title="function not covered" >function (path) {</span></span>
<span class="cstat-no" title="statement not covered" >                  root = root[path];</span>
                });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.resultset.sort(comparefun);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.sortDirty = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this;</span>
    };
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.resultset.compoundsort(criteria);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.sortDirty = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this;</span>
...
<span class="cstat-no" title="statement not covered" >          this.resultset.sort(this.sortFunction);</span>
        ...
        this.sortDirty = false;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.persistent) {
...
<span class="cstat-no" title="statement not covered" >        this.bs = BSonSort(fun);</span>
      },
      bs: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return BSonSort(this.sort);</span>
      },
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 24 2015 06:44:22 GMT+0000 (GMT)</div>
</div>
